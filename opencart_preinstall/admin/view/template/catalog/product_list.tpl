        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>
              <td class="hidden left"><?php if ($sort == 'p.model') { ?>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td class="hidden"><input type="text" name="filter_model" value="<?php echo $filter_model; ?>" /></td>
            ...
            <tr>
              ...
              <td class="hidden left"><?php echo $product['model']; ?></td>
