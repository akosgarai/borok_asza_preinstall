...
<div id="container">
    <div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/aszok_bora_logo_leveles_1_225x100.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
	<div class="div2_admin_text">| Admin</div>
    <?php if ($logged) { ?>
