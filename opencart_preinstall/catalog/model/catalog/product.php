...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
		...
		if (!empty($data['wineColor'])) {
			$sql .= " LEFT JOIN ". DB_PREFIX . "category_params_to_product cptpwc ON cptpwc.product_id = p.product_id";
		}
		if (!empty($data['wineSugar'])) {
			$sql .= " LEFT JOIN ". DB_PREFIX . "category_params_to_product cptpws ON cptpws.product_id = p.product_id";
		}
		...
		if (!empty($data['filter_manufacturer_id'])) {
			...
			if (!empty($data['wineColor'])) {
				$sql .= " AND cptpwc.category_param_id = '" . (int)$data["wineColor"] . "'";
			}
			if (!empty($data['wineSugar'])) {
				$sql .= " AND cptpws.category_param_id = '" . (int)$data["wineSugar"] . "'";
			}
